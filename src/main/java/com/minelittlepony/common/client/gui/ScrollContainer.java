...
public class ScrollContainer extends GameGui {
    ...
    public void init(Runnable contentInitializer) {
        ...
        getChildElements().addFirst(verticalScrollbar);
        getChildElements().addFirst(horizontalScrollbar);
    }
    ...
    public final void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float tickDelta) {
        ...
        GuiGraphicsExtractor subContext = new GuiGraphicsExtractor(minecraft, context.getRenderState(), subMouseX, subMouseY);
